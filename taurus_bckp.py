...
class Widget(Qt.QWidget):
	...
	def __init__(self):
		...
		self.setGeometry(1000, 300, 1000, 600)
	...
	def hbox2(self):
		...
		mot1 = 'tau/dummies/1/pos'

		self.groupBox2_1 = Qt.QGroupBox(mot1)
		self.groupBox2_1.setMaximumHeight(90)

		hbox1 = Qt.QHBoxLayout()

		self.line1 = Qt.QLineEdit(self)
		self.line1.setPlaceholderText('Schrittweite')
		self.line1.setMinimumHeight(40)
		...
		hbox1.addWidget(btn_step)

		self.line2 = Qt.QLineEdit(self)
		self.line2.setPlaceholderText('Zielposition')
		self.line2.setMinimumHeight(40)
		self.line2.setMaximumWidth(100)
		self.line2.setMaxLength(80)
		...
		hbox1.addWidget(buttonRR)

		self.groupBox2_1.setLayout(hbox1)
		vbox.addWidget(self.groupBox2_1)

		##############################################################
		mot2 = 'some motor'

		self.groupBox2_2 = Qt.QGroupBox('')
		self.groupBox2_2.setMaximumHeight(90)
		...
		self.groupBox2_2.setLayout(hbox1)
		vbox.addWidget(self.groupBox2_2)
